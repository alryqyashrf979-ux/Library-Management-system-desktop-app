...
namespace LibBusinessLayer
{
    public class clsBooks
    {
        ...
        public clsBooks(int bookID, string ArabicName, string EnglishName, string Category, string Author, string BookDesciption, 
            int Quantity, DateTime PublicationDate,string PicturePath, bool IsDeleted)
        {
            this.BookID = bookID;
        ...
        static public clsBooks FindBook(int ID)
        {
            ...
            if (ID <= 0)
            {
                ...
                ref Author, ref Category, ref PublicationDate, ref Quantity,ref PicTurePath , ref IsDeleted))
            {
                return new clsBooks(ID, BookArabicName, BookEnglishName, Category, Author, BookDescription, Quantity, PublicationDate,PicTurePath,IsDeleted);
            }
            else
                return null;
        }
        static public clsBooks FindBookByArabicName(string ArabicName)
        {
            ...
            string PicturePath = string.Empty ;
            bool IsDeleted = false;
            if (clsBooksDataAccess.FindBookByArabicName(ArabicName, ref ID, ref BookEnglishName, ref BookDescription, ref Author, ref Category,
                ref PublicationDate, ref Quantity,ref PicturePath , ref IsDeleted))
            {
                return new clsBooks(ID, ArabicName, BookEnglishName, Category, Author, BookDescription, Quantity, PublicationDate,PicturePath, IsDeleted);
            }
            return null;
        }
        static public clsBooks FindBookByEnglishName(string EnglishName)
        {
            ...
            bool IsDeleted = false;
            string PicturePath = string.Empty;
            if (clsBooksDataAccess.FindBookByEnglishName(ref BookArabicName, ref ID, EnglishName, ref BookDescription, ref Author, 
                ref Category, ref PublicationDate, ref Quantity , ref PicturePath , ref IsDeleted ))
            {
                return new clsBooks(ID, BookArabicName, EnglishName, Category, Author, BookDescription, Quantity, PublicationDate,PicturePath ,IsDeleted);
            }
            return null;
        }
        private bool _AddBook()
        {
            BookID = clsBooksDataAccess.AddBook(BookArabicName, BookEnglishName, BookDescription, Author, Category, PublicationDate, Quantity,PicturePath , IsDeleted);
            return (BookID > 0);
        ...
        private bool _EditBook()
        {
            return (clsBooksDataAccess.UpdateBook(this.BookID, this.BookArabicName, this.BookEnglishName, this.BookDescription,
                this.Author, this.Category, this.PublicationDate, this.Quantity,PicturePath,IsDeleted));
        }
        public bool Save()
        {
            switch (Mode)
        ...
        static public DataTable SearchBooksByArabicName(string ArabicTitle)
        {
            return clsBooksDataAccess.SearchBooksByArabicTitle(ArabicTitle);
        }
        static public DataTable SearchBooksbyEnglishName(string EnglishTitle)
        {
            return clsBooksDataAccess.SearchBooksByEnglishTitle(EnglishTitle);
        }
        static public DataTable SearchBooksByID(int ID)
        {
            return clsBooksDataAccess.SearchBooksByBookID(ID);
        }
        static public DataTable SearchBooksbyCategory(string Category)
        {
            return clsBooksDataAccess.SearchBooksByCategory(Category);
        }
        static public DataTable EmptyBooksTable()
        {
            return clsBooksDataAccess.EmptyBooksTable();        
        }
    }
}